...
//asking string one
 printf("Please enter the string one: "); scanf("%[^\n]%*c",string1);
...
//subtracting string1 and string2 and dividing by 2 and subtracting from string1
string2=string1-(string1-string2)/2;
//subtracting string1 and string2 and multiplying by 2 and 

//subtracting from string 1
